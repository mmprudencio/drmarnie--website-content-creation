# drmarnie--website-content-creation

Dr. Marnie's personal website and content platform — publish articles, promote services/books/courses, and capture patient leads, all on a domain she fully owns.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238495168+mmprudencio@users.noreply.github.com"
  git config user.name "mmprudencio"
  ```
